...
export default function ShowcasePage() {
  return <main className="hub-page case-page">
    ...
    <section className="hub-hero case-hero"><p>SHOWCASE / ÉTUDES DE CAS</p><h1>Le travail, <em>dans son contexte.</em></h1><div><p>Cette page ne cherche pas à reprendre la liste des projets. Elle met en avant quelques cas représentatifs, avec la question initiale, le système construit et les choix d’implémentation qui comptent.</p><span>05 études de cas · 04 projets complémentaires</span></div></section>
