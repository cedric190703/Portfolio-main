...
export default function ArticlesPage() {
  ...
  return <main className="hub-page articles-page">
    ...
    <section className="writing-note"><PenLine size={24} /><div><p>{copy.label}</p><h2>{language === "en" ? "New field notes will be added as the work evolves." : "De nouvelles notes de terrain seront ajoutées au fil des projets."}</h2></div></section>
